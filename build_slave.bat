...
:: Build into a dedicated dir with the slave config as SDKCONFIG. A per-variant
...
%IDF_PYTHON% %IDF_PATH%\tools\idf.py -B build_slave -D SDKCONFIG=%CD%\sdkconfig.slave -D NPM_EXECUTABLE=%NPM_EXE% build
