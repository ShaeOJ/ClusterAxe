...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_AUTO_TIMING_CALIBRATED]                = {.nvs_key_name = "autotimingcal",   .type = TYPE_BOOL,  .default_value = {.b   = false},                                       .rest_name = "autoTimingCalibrated",               .min = 0,  .max = 1},
    ...
    [NVS_CONFIG_BOARD_VERSION]                         = {.nvs_key_name = "boardversion",    .type = TYPE_STR,   .default_value = {.str = (char *)CONFIG_DEFAULT_BOARD_VERSION /* menuconfig: Bitaxe Configuration > Default board version */}},
